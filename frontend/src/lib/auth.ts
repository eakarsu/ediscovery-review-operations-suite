export const AUTH_COOKIE = 'ediscovery_review_operations_suite_session';
...
export const demoUsers: DemoUser[] = [
  {
    email: 'admin@ediscovery-review-operations.local',
    password: 'admin123',
    firstName: 'Legal',
    lastName: 'Operator',
    role: 'admin',
  ...
  {
    email: 'manager@ediscovery-review-operations.local',
    password: 'manager123',
    firstName: 'Legal',
    lastName: 'Manager',
    role: 'manager',
  ...
  {
    email: 'analyst@ediscovery-review-operations.local',
    password: 'analyst123',
    firstName: 'Legal',
    lastName: 'Analyst',
    role: 'analyst',
