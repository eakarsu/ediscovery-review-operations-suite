...
export const sourceSystems = [
  { name: 'AIeDiscoveryReviewOperationsAssistant', ownership: 'Records source capabilities and workflows', coverage: ['Records', 'Workspaces', 'Requests'] },
  { name: 'AIeDiscoveryReviewOperationsOperations', ownership: 'Workspaces source capabilities and workflows', coverage: ['Cases', 'Schedules', 'Resources'] },
  { name: 'AIeDiscoveryReviewOperationsAnalytics', ownership: 'Requests source capabilities and workflows', coverage: ['Approvals', 'Exceptions', 'Compliance'] },
  { name: 'AIeDiscoveryReviewOperationsWorkflow', ownership: 'Cases source capabilities and workflows', coverage: ['Analytics', 'Forecasts', 'Reports'] },
];
