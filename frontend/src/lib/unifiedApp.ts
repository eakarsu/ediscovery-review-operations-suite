...
const features = [
  {
    ...
    summary: 'Records workflow normalized for the eDiscovery Review Operations suite with records, queues, approvals, audit, and reporting.',
    bullets: ['Records queue', 'Approvals', 'Audit trail'],
    metrics: [{ label: 'Records', value: '24', note: 'Active' }, { label: 'Exceptions', value: '3', note: 'Need review' }, { label: 'Due Soon', value: '5', note: 'Next 14 days' }],
  },
  {
    slug: 'workspaces',
    title: 'Workspaces',
    ...
    category: 'Operations',
    icon: Users,
    summary: 'Workspaces workflow normalized for the eDiscovery Review Operations suite with records, queues, approvals, audit, and reporting.',
    bullets: ['Workspaces queue', 'Approvals', 'Audit trail'],
    metrics: [{ label: 'Workspaces', value: '35', note: 'Active' }, { label: 'Exceptions', value: '4', note: 'Need review' }, { label: 'Due Soon', value: '6', note: 'Next 14 days' }],
  },
  {
    slug: 'requests',
    title: 'Requests',
    ...
    category: 'Operations',
    icon: ClipboardList,
    summary: 'Requests workflow normalized for the eDiscovery Review Operations suite with records, queues, approvals, audit, and reporting.',
  ...
  },
  {
    ...
    category: 'Operations',
    icon: CalendarCheck,
    summary: 'Cases workflow normalized for the eDiscovery Review Operations suite with records, queues, approvals, audit, and reporting.',
    bullets: ['Cases queue', 'Approvals', 'Audit trail'],
    metrics: [{ label: 'Cases', value: '57', note: 'Active' }, { label: 'Exceptions', value: '6', note: 'Need review' }, { label: 'Due Soon', value: '8', note: 'Next 14 days' }],
  },
  {
    slug: 'schedules',
    title: 'Schedules',
    ...
    category: 'Operations',
    icon: Activity,
    summary: 'Schedules workflow normalized for the eDiscovery Review Operations suite with records, queues, approvals, audit, and reporting.',
    bullets: ['Schedules queue', 'Approvals', 'Audit trail'],
    metrics: [{ label: 'Schedules', value: '68', note: 'Active' }, { label: 'Exceptions', value: '7', note: 'Need review' }, { label: 'Due Soon', value: '9', note: 'Next 14 days' }],
  },
  {
    slug: 'resources',
    title: 'Resources',
    ...
    category: 'Operations',
    icon: Workflow,
    summary: 'Resources workflow normalized for the eDiscovery Review Operations suite with records, queues, approvals, audit, and reporting.',
  ...
  },
  {
    ...
    category: 'Operations',
    icon: FileText,
    summary: 'Approvals workflow normalized for the eDiscovery Review Operations suite with records, queues, approvals, audit, and reporting.',
  ...
  },
  {
    ...
    category: 'Operations',
    icon: ShieldCheck,
    summary: 'Exceptions workflow normalized for the eDiscovery Review Operations suite with records, queues, approvals, audit, and reporting.',
  ...
  },
  {
    ...
    category: 'Governance',
    icon: BarChart3,
    summary: 'Compliance workflow normalized for the eDiscovery Review Operations suite with records, queues, approvals, audit, and reporting.',
  ...
  },
  {
    ...
    category: 'Governance',
    icon: PackageCheck,
    summary: 'Analytics workflow normalized for the eDiscovery Review Operations suite with records, queues, approvals, audit, and reporting.',
    bullets: ['Analytics queue', 'Approvals', 'Audit trail'],
    metrics: [{ label: 'Analytics', value: '123', note: 'Active' }, { label: 'Exceptions', value: '12', note: 'Need review' }, { label: 'Due Soon', value: '14', note: 'Next 14 days' }],
  },
  {
    slug: 'forecasts',
    title: 'Forecasts',
    ...
    icon: Bell,
    summary: 'Forecasts workflow normalized for the eDiscovery Review Operations suite with records, queues, approvals, audit, and reporting.',
  ...
  },
  {
    ...
    category: 'Intelligence Layer',
    icon: Files,
    summary: 'Reports workflow normalized for the eDiscovery Review Operations suite with records, queues, approvals, audit, and reporting.',
  ...
  },
  {
    ...
    icon: Files,
    summary: 'eDiscovery Review Operations documents, packets, evidence, attachments, and exports.',
  ...
  },
  {
    ...
    category: 'Core Platform',
    icon: Bell,
    summary: 'eDiscovery Review Operations alerts, reminders, exceptions, and approvals.',
  ...
  },
  {
    ...
    category: 'Core Platform',
    icon: Plug,
    summary: 'eDiscovery Review Operations source-system connector health and sync status.',
  ...
  },
  {
    ...
    category: 'Core Platform',
    icon: UserRound,
    summary: 'eDiscovery Review Operations users, roles, teams, permissions, and ownership settings.',
...
const aiFeatures = [
  {
    ...
    category: 'Intelligence Layer',
    icon: Bot,
    summary: 'eDiscovery Review Operations assistant for triage, summaries, drafting, recommendations, and operational review.',
...
export const featureFamilies = [
  { name: 'Operations', features: ['Records', 'Workspaces', 'Requests', 'Cases', 'Schedules', 'Resources', 'Approvals', 'Exceptions'] },
  { name: 'Operations', features: ['Records', 'Workspaces', 'Requests', 'Cases', 'Schedules', 'Resources', 'Approvals', 'Exceptions'] },
  { name: 'Governance', features: ['Compliance', 'Analytics'] },
...
export const featureContexts: Record<string, FeatureContext> = Object.fromEntries(
  allFeatures.map((feature) => [
    feature.title,
    {
      sourceOwners: ['AIeDiscoveryReviewOperationsAssistant', 'AIeDiscoveryReviewOperationsOperations where applicable'],
