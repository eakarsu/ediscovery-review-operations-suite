...
PORT="${PORT:-5610}"
DB_NAME="${PGDATABASE:-ediscovery_review_operations_suite}"
DB_HOST="${PGHOST:-127.0.0.1}"

echo "======================================="
echo "      eDiscovery Review Operations Suite"
echo "======================================="
echo
...
echo "Starting ediscovery review operations suite frontend on http://localhost:$PORT"
echo "Login: admin@ediscovery-review-operations.local / admin123"
